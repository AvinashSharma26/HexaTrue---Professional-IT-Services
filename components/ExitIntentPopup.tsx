      ...
      <div className="relative bg-white rounded-[2rem] shadow-2xl max-w-md w-full p-6 md:p-8 overflow-hidden border border-slate-100">
        ...
        {isSuccess ? (
          <div className="text-center py-8 animate-fade-in-up">
            <div className="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center text-white mx-auto mb-6 shadow-xl shadow-blue-100">
              <svg xmlns="http://www.w3.org/2000/svg" className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M5 13l4 4L19 7" />
              </svg>
            </div>
            <h2 className="text-2xl font-black text-slate-900 mb-4">Strategy Session Booked</h2>
            <p className="text-slate-600 text-sm font-medium mb-8">
              Thank you! Our experts will contact you shortly.
            </p>
            <button 
              onClick={onClose}
              className="bg-slate-900 text-white px-8 py-3 rounded-xl text-sm font-bold shadow-lg hover:bg-slate-800 transition-all"
            >
              Back to Site
            </button>
          </div>
